...
#    Updated: 2022/06/03 15:32:29 by swautele         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES = main.c errors.c cub_file.c utils.c file_extractors.c map_extractor.c init_window.c distance.c check_walls.c move.c
